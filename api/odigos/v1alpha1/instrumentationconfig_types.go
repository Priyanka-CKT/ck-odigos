...
// KarmaInstrumentationConfig is the Schema for the karmainstrumentationconfig API
type KarmaInstrumentationConfig struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   KarmaInstrumentationConfigSpec   `json:"spec,omitempty"`
	Status KarmaInstrumentationConfigStatus `json:"status,omitempty"`
}

type KarmaInstrumentationConfigStatus struct {
...
type KarmaInstrumentationConfigSpec struct {
...
type KarmaInstrumentationConfigList struct {
	...
	Items           []KarmaInstrumentationConfig `json:"items"`
}

func init() {
	SchemeBuilder.Register(&KarmaInstrumentationConfig{}, &KarmaInstrumentationConfigList{})
}

// Languages returns the set of languages that this configuration applies to
func (ic *KarmaInstrumentationConfig) Languages() map[common.ProgrammingLanguage]struct{} {
...
type InstrumentationConfig = KarmaInstrumentationConfig
type InstrumentationConfigSpec = KarmaInstrumentationConfigSpec
type InstrumentationConfigStatus = KarmaInstrumentationConfigStatus
type InstrumentationConfigList = KarmaInstrumentationConfigList
