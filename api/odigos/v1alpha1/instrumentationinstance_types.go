...
type KarmaInstrumentationInstanceSpec struct {
	// +required
...
// KarmaInstrumentationInstanceStatus defines the observed state of KarmaInstrumentationInstance
// If the instrumentation is not active, this CR should be deleted
type KarmaInstrumentationInstanceStatus struct {
...
// KarmaInstrumentationInstance is the Schema for the KarmaInstrumentationInstances API
type KarmaInstrumentationInstance struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   KarmaInstrumentationInstanceSpec   `json:"spec,omitempty"`
	Status KarmaInstrumentationInstanceStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// KarmaInstrumentationInstanceList contains a list of KarmaInstrumentationInstance
type KarmaInstrumentationInstanceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []KarmaInstrumentationInstance `json:"items"`
}

func init() {
	SchemeBuilder.Register(&KarmaInstrumentationInstance{}, &KarmaInstrumentationInstanceList{})
}

// Type aliases for backward compatibility
type InstrumentationInstance = KarmaInstrumentationInstance
type InstrumentationInstanceSpec = KarmaInstrumentationInstanceSpec
type InstrumentationInstanceStatus = KarmaInstrumentationInstanceStatus
type InstrumentationInstanceList = KarmaInstrumentationInstanceList
