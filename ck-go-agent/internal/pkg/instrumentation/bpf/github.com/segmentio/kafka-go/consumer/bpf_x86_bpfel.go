...
type bpfKafkaConsumerGroupT struct{ ConsumerGroup [128]int8 }
...
type bpfMapSpecs struct {
	...
	KafkaConsumerGroupMap        *ebpf.MapSpec `ebpf:"kafka_consumer_group_map"`
	KafkaConsumerGroupStorageMap *ebpf.MapSpec `ebpf:"kafka_consumer_group_storage_map"`
...
type bpfMaps struct {
	...
	KafkaConsumerGroupMap        *ebpf.Map `ebpf:"kafka_consumer_group_map"`
	KafkaConsumerGroupStorageMap *ebpf.Map `ebpf:"kafka_consumer_group_storage_map"`
...
func (m *bpfMaps) Close() error {
	return _BpfClose(
		...
		m.KafkaConsumerGroupMap,
		m.KafkaConsumerGroupStorageMap,
		m.KafkaEvents,
		m.KafkaReaderToConn,
