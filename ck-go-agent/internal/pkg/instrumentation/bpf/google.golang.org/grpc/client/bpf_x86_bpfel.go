...
type bpfCompositeHttpStreamKey struct {
	ConnPtr uint64
	Nextid  uint32
	_       [4]byte
}
...
type bpfMapSpecs struct {
	...
	CompositeHttpStreamKeyToSpanContexts *ebpf.MapSpec `ebpf:"composite_http_stream_key_to_span_contexts"`
...
type bpfVariableSpecs struct {
	...
	HttpclientConnPos      *ebpf.VariableSpec `ebpf:"httpclient_conn_pos"`
	HttpclientNextidPos    *ebpf.VariableSpec `ebpf:"httpclient_nextid_pos"`
	IsRegistersAbi         *ebpf.VariableSpec `ebpf:"is_registers_abi"`
	LoopywriterConnPos     *ebpf.VariableSpec `ebpf:"loopywriter_conn_pos"`
...
type bpfMaps struct {
	...
	CompositeHttpStreamKeyToSpanContexts *ebpf.Map `ebpf:"composite_http_stream_key_to_span_contexts"`
...
func (m *bpfMaps) Close() error {
	return _BpfClose(
		m.AllocMap,
		m.CompositeHttpStreamKeyToSpanContexts,
		m.Events,
		m.GoContextToSc,
		m.GrpcEvents,
...
type bpfVariables struct {
	...
	HttpclientConnPos      *ebpf.Variable `ebpf:"httpclient_conn_pos"`
	HttpclientNextidPos    *ebpf.Variable `ebpf:"httpclient_nextid_pos"`
	IsRegistersAbi         *ebpf.Variable `ebpf:"is_registers_abi"`
	LoopywriterConnPos     *ebpf.Variable `ebpf:"loopywriter_conn_pos"`
