...
type bpf_no_tpMapSpecs struct {
	...
	HttpHeadersSizeMap         *ebpf.MapSpec `ebpf:"http_headers_size_map"`
...
type bpf_no_tpVariableSpecs struct {
	...
	ResponseHeaderPtrPos *ebpf.VariableSpec `ebpf:"response_header_ptr_pos"`
...
type bpf_no_tpMaps struct {
	...
	HttpHeadersSizeMap         *ebpf.Map `ebpf:"http_headers_size_map"`
...
type bpf_no_tpVariables struct {
	...
	ResponseHeaderPtrPos *ebpf.Variable `ebpf:"response_header_ptr_pos"`
