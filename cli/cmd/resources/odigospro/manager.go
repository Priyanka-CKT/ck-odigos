...
func NewOdigosProResourceManager(client *kube.Client, ns string, config *common.CodekarmaConfiguration, odigosTier common.OdigosTier, proTierToken *string) resourcemanager.ResourceManager {
