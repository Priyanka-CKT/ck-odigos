...
spec:
  template:
    spec:
      ...
      - resources:
          limits:
            instrumentation.codekarma.tech/go-ebpf-community: "1"
```

The `instrumentation.codekarma.tech/go-ebpf-community` resource limit instruct Odigos on how to mount the relevant OpenTelemetry agent and environment variables into the container, 
